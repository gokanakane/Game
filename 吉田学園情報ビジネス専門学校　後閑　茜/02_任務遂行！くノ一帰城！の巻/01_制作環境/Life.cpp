...
void InitLife(void)
{
	...
	for (nCnt = 0; nCnt < MAXPLAYER_LIFE; nCnt++)
	{
		g_bUse[nCnt] = true;
	}
...
void UpdateLife(void)
{
	...
	for (nCnt = 0; nCnt < MAXPLAYER_LIFE; nCnt++)
	{
		...
		{
			// 頂点情報を設定	
			pVtx[0].pos = D3DXVECTOR3(100.0f + (50 * nCnt), 30.0f, 0.0f);//一つ目の頂点の場所指定
			pVtx[1].pos = D3DXVECTOR3(150.0f + (50 * nCnt), 30.0f, 0.0f);//二つ目の頂点の場所指定（右回り）
			pVtx[2].pos = D3DXVECTOR3(100.0f + (50 * nCnt), 90.0f, 0.0f);//三つ目の頂点の場所指定（右回り）
			pVtx[3].pos = D3DXVECTOR3(150.0f + (50 * nCnt), 90.0f, 0.0f);//三つ目の頂点の場所指定（右回り）
...
void MakeVertexLife(LPDIRECT3DDEVICE9 pDevice)
{
	...
	{		
		...
		pVtx[2].pos = D3DXVECTOR3(0.0f, 60.0f, 0.0f);//三つ目の頂点の場所指定（右回り）
		pVtx[3].pos = D3DXVECTOR3(0.0f, 60.0f, 0.0f);//三つ目の頂点の場所指定（右回り）
