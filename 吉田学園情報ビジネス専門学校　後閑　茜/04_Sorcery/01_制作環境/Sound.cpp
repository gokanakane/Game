...
IXAudio2SourceVoice *CSound::m_apSourceVoice[CSound::SOUND_LABEL_MAX] = {};	// ソースボイスへのポインタ
BYTE *CSound::m_apDataAudio[CSound::SOUND_LABEL_MAX] = {};					// オーディオデータへのポインタ
...
{//列挙型の順番と合わせる
	...
	{ "data/BGM/StageSelect.wav", -1},	// BGM1
	{ "data/BGM/CharactorSelect.wav", -1 },	// BGM1
	{ "data/BGM/GameOver.wav", -1},		// BGM2
	{ "data/BGM/GameCliar.wav", -1 },	// BGM3
	{ "data/BGM/Tutorial.wav", -1 },	// BGM4
	{ "data/BGM/Ranking.wav", -1 },		// BGM5
	{ "data/BGM/stage1.wav", -1 },		// ステージ1
	{ "data/BGM/stage2.wav", -1 },		// ステージ2
	{ "data/BGM/stage3.wav", -1 },		// ステージ3
	{ "data/BGM/stage4.wav", -1 },		// ステージ4
	{ "data/SE/NoSelect.wav", 0 },		// 選択不可
	{ "data/SE/Select.wav",0},			//選択	
	{ "data/SE/cursor.wav",0},			//カーソル選択	
	{ "data/SE/Skill.wav",0},			//スキル	
	{ "data/SE/hit000.wav",0 },			//スキル	
	{ "data/SE/hit001.wav",0 },			//スキル
	{ "data/SE/Drain.wav",0 }			//スキル	
