...
CManager::StageSelectState CManager::m_StageSelect = StageSelectState::STAGESELECT_STAGE1;
CManager::CHARACTORSELECT_STATE CManager::m_CharactorSelect = CManager::CHARACTORSTATE_DORAGON;
